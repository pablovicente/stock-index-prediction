...
from helpers import features_analysis, procces_stocks, data_manipulation, ml_dataset, classifier_utils, report_generator, Iteration, Stacking, Boosting
...
GOLD = data_manipulation.read_csv_data('Data/GOLD.csv')
SILVER = data_manipulation.read_csv_data('Data/SILVER.csv')
PLAT = data_manipulation.read_csv_data('Data/PLAT.csv')
OIL_BRENT = data_manipulation.read_csv_data('Data/OIL_BRENT.csv')

USD_GBP = data_manipulation.read_csv_data('Data/USD_GBP.csv')
JPY_USD = data_manipulation.read_csv_data('Data/JPY_USD.csv')
AUD_USD = data_manipulation.read_csv_data('Data/AUD_USD.csv')

INDEX_DJIA = data_manipulation.read_csv_data('Data/INDEX_DJIA.csv')
INDEX_HSI = data_manipulation.read_csv_data('Data/INDEX_HSI.csv')
INDEX_IBEX = data_manipulation.read_csv_data('Data/INDEX_IBEX.csv')
INDEX_N225 = data_manipulation.read_csv_data('Data/INDEX_N225.csv')
INDEX_SP500 = data_manipulation.read_csv_data('Data/INDEX_SP500.csv')
INDEX_AXJO = data_manipulation.read_csv_data('Data/INDEX_AXJO.csv')
INDEX_FCHI = data_manipulation.read_csv_data('Data/INDEX_FCHI.csv')
INDEX_GDAXI = data_manipulation.read_csv_data('Data/INDEX_GDAXI.csv')
...
testingPeriodList = [(1, '1_days'),(3, '3_days'),(5, '5_days'),(10, '10_days'), (30, '30_days'), (40, '40_days'), (50, '50_days'), (100, '100_days'), (200, '200_days')]
step = 400
...
for trainingPeriod, key_year in trainingPeriodList:    
    ...
    for index in range(0,dataset.shape[0] - trainingPeriod - 201, step):
        print "--------------------------------------------------"
        ...
        trainDates.append(index + trainingPeriod)
        ...
        for testingPeriod, key_test in testingPeriodList:
            ...
            testDates.append(index + trainingPeriod + testingPeriod + 1)
            ...
            print "Training: from %s to %s" % (str(dataset.Date[trainDates[0]]), str(dataset.Date[trainDates[1]]))
            print "Testing: from %s to %s" % (str(dataset.Date[testDates[0]]), str(dataset.Date[testDates[1]]))
