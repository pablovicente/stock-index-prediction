...
testing_dates  = Iteration.Iteration('2015-12-02', '2016-04-20')
    ...
    for key_exp in keys_exp:
        ...
        for regex_element in regex_list:
            ...
            for date in date_list:
                ...
                mean_accuracy = 0.0
                iter_ = 1
                clf.fit_predict(trainY, trainX)
                cv_preds, models_score, models_f1 = clf.fit_predict(trainY, trainX, testX, testY, show_steps=True)
