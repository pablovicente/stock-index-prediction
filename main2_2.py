...
for key_d in keys_dates:
    ...
    x_np, variance = features_analysis.pca_analysis(x_np, 3)
    ...
    for iteration in date_list:
        ...
        for index_test in range(0,len(testing_list),2):
            ...
            trainX, trainY, testX, testY = ml_dataset.np_train_arrays_experiments(x_np, y_np, trainDates, testDates)
